...
<head>
    ...
    <link rel="icon" href="https://res.cloudinary.com/dicmh7cfa/image/upload/v1655220438/logos%20monfu%202022/image_1_wzq9wi.png" type="image/x-icon">
...
<body data-fade-in="true" role="main">
    ...
    <nav class="p-3 mb-5 shadow navbar nav-down m-ocult" id="hed" data-fullwidth="true" data-menu-style="transparent" data-animation="shrink">
        ...
        <script>
            ...
            const menuToggles = document.querySelector(".nav__toggles");
            let isMenuOpen = false;

            // TOGGLE MENU ACTIVE STATE
            menuToggles.addEventListener("click", (e) => {
                e.preventDefault();
                isMenuOpen = !isMenuOpen;

                // toggle a11y attributes and active class
                menuToggles.setAttribute("aria-expandeds", String(isMenuOpen));
                menus.hidden = !isMenuOpen;
                navs.classList.toggle("nav--opens");
            });

            // TRAP TAB INSIDE NAV WHEN OPEN
            navs.addEventListener("keydown", (e) => {
                ...
                const menuLinks = menus.querySelectorAll(".nav__links");
                if (e.keyCode === 9) {
                    if (e.shiftKey) {
                    ...
                    } else if (document.activeElement === menuToggles) {
                        menuLinks[0].focus();
                        e.preventDefault();
                    }
                }
        ...
        <style>
            ...
            .navs:target>.splashs::after,
            .nav--opens>.splashs::after {
                transform: scale(1);
            }
            
            .navs:target .menuicons,
            .nav--opens .menuicons {
                color: white;
                transform: rotate(180deg);
            }
            
            .navs:target .menuicon__circles,
            .nav--opens .menuicon__circles {
                stroke-dashoffset: 0;
            }
            
            .navs:target .menuicon__bars:nth-child(1),
            .navs:target .menuicon__bars:nth-child(4),
            .nav--opens .menuicon__bars:nth-child(1),
            .nav--opens .menuicon__bars:nth-child(4) {
                opacity: 0;
            }
            
            .navs:target .menuicon__bars:nth-child(2),
            .nav--opens .menuicon__bars:nth-child(2) {
                transform: rotate(45deg);
            }
            
            .navs:target .menuicon__bars:nth-child(3),
            .nav--opens .menuicon__bars:nth-child(3) {
                transform: rotate(-45deg);
            }
            
            .navs:target .nav__menus,
            .nav--opens .nav__menus {
                visibility: visible;
            }
            
            .navs:target .nav__menu2,
            .nav--opens .nav__menu2 {
                visibility: visible;
            }
            
            .navs:target .nav__items,
            .nav--opens .nav__items {
                opacity: 1;
    ...
    <div class="viewports" style="position: fixed; z-index: 100;">
        <header class="headers" role="banners">
            <nav id="navs" class="navs" role="navigations">
                ...
                <ul class="nav__menus" id="menus" tabindex="-1" aria-label="main navigation" hidden>
        ...
        <div class="container">
            <div class="row">
                ...
                <script>
                    ...
                    var countDownDate = new Date("Nov 23, 2022 23:59:59").getTime();
                    ...
                    var x = setInterval(function() {
                        ...
                        document.getElementById("dias").innerHTML = 'Faltan ' + days + ' días';
                    ...
                    <div class="col-sm-8 feature-left event" style="overflow: scroll ;max-height: 350px;">
                        <p class="lead" style="text-align: justify;line-height: 40px;font-size: clamp(1rem, 4vw, 2rem);">
                            ...
                            <style>
                                ...
                                .toolTip .toolTipText {
                                    ...
                                    text-align: center;
                                    transition: 1s;
                                    background: rgba( 0, 103, 192, 0.65);
                                    box-shadow: 0 8px 32px 0 rgba( 31, 38, 135, 0.37);
                                ...
                                .flecha {
                                    ...
                                    border-width: 530;
                                    border-style: solid;
                                    border-color: transparent transparent #0067C0 transparent
                                }
                            </style>

                            tiene como objetivo trasferir conocimiento cientifico sobre los ecosistemas de montaña y los glaciares tropicales, en un contexto de cambio climático.
                        </p>
                        <p class="lead" style="text-align: justify;line-height: 40px;font-size: clamp(1rem, 4vw, 2rem);">
                        ...
                        <p class="lead" style="text-align: justify;line-height: 40px;font-size: clamp(1rem, 4vw, 2rem);">
                            ...
                            <style>
                                ...
                                .active-acordion .fa-minus {
                                    display: block;
                                }
                                
                                .active-acordion .fa-plus {
                                    display: none;
                                }
        ...
        <div class="container" style="background-color: transparent;">
            <div class="row">
                <div class="text-center col-md-12 pb30 ">
                    ...
                    <br> <br>
                    <div class="col-sm-12" style="display: flex;   margin: auto;
                    overflow: hidden;
                    position: relative;">
                        ...
                        <div class="col-sm-3 feature-left marvca">
                            <div class="feature-left-content">
                                <a href="https://www.gob.pe/minam" target="_blank"> <img src="https://res.cloudinary.com/dicmh7cfa/image/upload/v1656617196/logos%20monfu%202022/logos_menu/Canada_tvh6g6.svg" alt="" width="80%" /></a>
                            </div>
                        </div>
                    </div>
                    <br><br>
                        ...
                        forms.addEventListener("submit", (e) => {
                            ...
                            fetch(scriptURLS, {
                                ...
                                .then((response) => {
                                    ...
                                    alertify.success('<h4 style="color:white">Mensaje Enviado</h4>  ');
                                    limpiarFormulario();
